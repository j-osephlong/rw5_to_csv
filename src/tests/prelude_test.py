...
def test_parse_prelude():
    prelude = r"""JB,NM24116BLC240611,DT06-11-2024,TM14:22:14
    ...
    with TemporaryDirectory() as tmpdir:
        ...
        path.write_text(prelude, encoding="utf-8")
        prelude_data = get_prelude(path)
        ...
        assert prelude_data["SerialNumber"] == "D2133624904116"
        assert (
